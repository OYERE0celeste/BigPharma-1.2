...
class FinanceService {
  ...
  // Méthodes pour intégration future avec les modules
  void addTransactionFromSales(FinanceTransactionModel transaction) {
    // Simulation d'ajout depuis le module ventes
    _transactions.add(transaction);
  }

  void addTransactionFromStock(FinanceTransactionModel transaction) {
    // Simulation d'ajout depuis le module stocks
    _transactions.add(transaction);
  }

  void addTransactionFromSuppliers(FinanceTransactionModel transaction) {
    // Simulation d'ajout depuis le module fournisseurs
    _transactions.add(transaction);
  }

  void addTransactionFromActivityRegister(FinanceTransactionModel transaction) {
    // Simulation d'ajout depuis le registre d'activités
    _transactions.add(transaction);
  }

  // Export des données (simulation)
  String exportToJson() {
    return jsonEncode(_transactions.map((t) => t.toJson()).toList());
  }
