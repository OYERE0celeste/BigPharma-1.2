                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            CategoryChip(label: 'Anti-inflammatoire', onTap: () {}),
                            const SizedBox(width: 8),
                      ...
                      FutureBuilder<List<Product>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasError || !snapshot.hasData || snapshot.data!.isEmpty) {
                            return _buildErrorState('Aucun produit populaire trouvé');
                          }
                      ...
                      SizedBox(
                        ...
                        child: FutureBuilder<List<Product>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasError || !snapshot.hasData || snapshot.data!.isEmpty) {
                              return const Center(child: Text('Aucune nouveauté'));
                            }
                            final products = snapshot.data!;
                              ...
                              itemBuilder: (_, int index) {
                                return SizedBox(
                                  ...
                                  child: ProductCard(
                                    ...
                                    onAddTap: () {
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('${products[index].name} ajouté au panier')),
                                      );
                                    },
                                    onDetailsTap: () {
                                      Navigator.push(
